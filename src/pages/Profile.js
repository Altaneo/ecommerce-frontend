...
const ProfileLayout = () => {
  return (
    <div className="flex mt-24 bg-purple-50">
      {/* Sidebar */}
      <div
        className="bg-white text-black p-4 rounded-lg shadow-md w-64 border border-purple-800 mt-5 max-h-[100vh] overflow-y-auto sticky top-4"
      >
        ...
        <nav className="flex flex-col gap-2">
          <NavLink
            ...
            className={({ isActive }) =>
              `block p-2 rounded transition-colors duration-200 ${isActive
