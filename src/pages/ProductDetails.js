                        ...
                        <div className="mt-2 flex items-center">
                            ...
                            <div className="flex">
                                {Array.from({ length: 5 }, (_, index) => (
                                    <svg
                                        key={index}
                                        className={`h-6 w-6 ${index < Math.round(averageRating) ? 'text-yellow-500' : 'text-gray-300'}`}
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                    ...
                                    <div key={index} className="py-4 border-b">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <p className="text-sm text-gray-500">
                                                {new Date(review.createdAt).toLocaleString()} {/* Formats date and time */}
                                            </p>
                                        </div>
                                ...
                                {Array(5)
                                    ...
                                    .map((_, index) => (
                                        <svg
                                            ...
                                            xmlns="http://www.w3.org/2000/svg"
                                            className={`h-6 w-6 cursor-pointer ${index < newRating ? 'text-yellow-500' : 'text-gray-300'}`}
                                            fill="currentColor"
                                            viewBox="0 0 20 20"
                                        >
                                            <path d="M9.049 2.927a1 1 0 011.902 0l1.285 4.153a1 1 0 00.95.69h4.373a1 1 0 01.592 1.806l-3.542 2.58a1 1 0 00-.364 1.118l1.285 4.153a1 1 0 01-1.541 1.118L10 14.347l-3.542 2.58a1 1 0 01-1.541-1.118l1.285-4.153a1 1 0 00-.364-1.118L2.796 9.576a1 1 0 01.592-1.806h4.373a1 1 0 00.95-.69L9.049 2.927z" />
